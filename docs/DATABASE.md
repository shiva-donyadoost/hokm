...
| 0004_games_room_fk | games.room_id FK cleanup |
| 0005_avatar_seed | users.avatar_seed |
| 0006_avatar_style | users.avatar_style (lorelei/avataaars) |

## Key tables

- `users` — text PK (app-generated crypto IDs), unique username/email,
  bcrypt password hash, guest flag, optional avatar_seed + avatar_style
  (DiceBear gallery; ADR-0017/0018).
